...
export default function YangpanHistoryPage() {
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="bg-card border-b border-border sticky top-0 z-20">
        <div className="flex items-center justify-between px-4 py-3">
          <Link href="/paipan/yangpan" className="flex items-center text-muted-foreground hover:text-foreground">
          ...
          <div className="flex bg-secondary rounded-full p-0.5">
            ...
            <Link
              href="/paipan/bazi/history/celebrities"
        ...
        {showMenu && (
          <>
            ...
            <div className="absolute right-3 top-12 bg-card rounded-xl shadow-xl z-20 py-2 min-w-[140px] animate-in fade-in slide-in-from-top-2 duration-200">
              <Link 
                href="/paipan/yangpan/history/groups"
