...
| B 已上线 vue | 旧原型 | 顶级活页 |
|---|---|---|
| `pkg-mine/points` | `/mine/points` | `/points`（336行真实活页） |
| `pkg-mine/history` | `/mine/history` | `/history`（239行真实活页） |
| `pkg-mine/my-likes` | `/mine/my-likes` | `/likes`（244行真实活页，待确认「点赞/获赞」语义一致） |
| `pkg-mine/my-comments` / `received-comments` | `/mine/my-comments` 等 | 待 CC 核对是否有顶级活页 |
