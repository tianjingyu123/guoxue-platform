    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="bg-gradient-to-br from-primary/10 to-gold/10 p-8 text-center">
          <div className="w-20 h-20 mx-auto mb-4 rounded-2xl overflow-hidden bg-card flex items-center justify-center shadow-lg">
            <img src="/images/logo.jpg" alt="热卜国学 Logo" className="w-full h-full object-cover" />
          </div>
