  ...
  <div class="page">
    <div class="toolbar">
      ...
      <div style="display:flex;gap:8px">
        <el-select v-model="statusFilter" placeholder="状态" clearable size="small" style="width:120px" @change="fetchList">
    ...
    <el-dialog v-model="detailVis" title="调用详情" width="550px">
      <el-descriptions v-if="detail.id" :column="1" border>
        ...
        <el-descriptions-item label="请求参数"><pre style="max-height:200px;overflow:auto;margin:0;font-size:12px">{{ JSON.stringify(detail.requestParams || {}, null, 2) }}</pre></el-descriptions-item>
        <el-descriptions-item label="响应内容"><pre style="max-height:200px;overflow:auto;margin:0;font-size:12px">{{ JSON.stringify(detail.response || {}, null, 2) }}</pre></el-descriptions-item>
