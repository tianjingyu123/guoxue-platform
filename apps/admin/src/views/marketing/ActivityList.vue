  ...
  <div class="page">
    ...
    <el-dialog v-model="vis" :title="editingId ? '编辑活动' : '创建活动'" width="550px">
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="类型"><el-select v-model="form.type" style="width:100%"><el-option label="满减送" value="FULL_REDUCTION" /><el-option label="限量抢购" value="LIMITED_PURCHASE" /><el-option label="节日活动" value="HOLIDAY" /><el-option label="自定义" value="CUSTOM" /></el-select></el-form-item>
