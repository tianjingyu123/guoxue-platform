        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="二维码引导语">
              <el-input
                v-model="form.qrGuide"
                maxlength="100"
                placeholder="长按识别 · 开启国学之旅"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="主域名">
              <el-input
                v-model="form.domain"
                maxlength="200"
                placeholder="api.your-domain.invalid"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const { captureBaseline } = useUnsavedChanges(() => form);
...
@media (max-width: 768px) {
  ...
  .card-sub { display: block; margin: 6px 0 0; line-height: 1.6; }
  .brand-form :deep(.el-col-12) { flex: 0 0 100%; max-width: 100%; }
}
</style>
