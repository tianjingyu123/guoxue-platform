...
<template>
  <el-dialog v-model="visible" :title="props.title" width="420px" append-to-body>
    <div style="margin-bottom: 16px">
      <el-alert :type="props.level === 'danger' ? 'error' : 'warning'" :closable="false" show-icon>
        <template #title>{{ props.message }}</template>
      </el-alert>
    </div>
    <div v-if="props.requireInput">
      ...
      <el-input v-model="inputValue" :placeholder="props.inputPlaceholder" @keyup.enter="handleConfirm" />
    </div>
    <template #footer>
