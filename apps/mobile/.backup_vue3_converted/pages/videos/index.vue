    ...
    <view v-if="searchActive" class="px-4 pb-3">
      ...
      <view class="flex gap-2 mt-2">
        <view
          ...
          :class="selectedTag === tag ? 'bg-primary text-white' : 'bg-muted text-muted-foreground'"
