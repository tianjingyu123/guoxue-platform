      ...
      <view class="main">
        ...
        <block v-if="step === 1">
          ...
          <view class="primary-btn" :class="{ 'btn-disabled': !canNext1 }" @tap="canNext1 && (step = 2)">
            <text class="primary-btn-text">下一步：选择成员身份</text>
          </view>
        </block>
        ...
        <block v-if="step === 3">
          <view class="deposit-card">
            ...
            <text class="deposit-sub">完成分享任务后可全额退还</text>
          </view>

          <view class="card">
            <text class="card-title plain">会费说明</text>
            <view class="desc-list">
              <text class="desc-line">1. 全员缴纳相同会费，交费即可加入，不做事前资格审核。</text>
              <text class="desc-line">2. 申请分享并完成全部任务者，年度周期结束后全额退还会费。</text>
              <text class="desc-line">3. 仅参与学习而不分享，会费不予退还（相当于高端学习社群年费）。</text>
              <text class="desc-line">4. 会费有效期为 1 年，到期后需续费或完成任务申请退还。</text>
            </view>
          </view>
        ...
        <block v-if="step === 4">
          <view class="success-wrap">
            ...
            <view class="card next-card">
              ...
              <view class="desc-list">
                <text class="desc-line">1. 审核通过后，你将正式成为研究院成员</text>
                <text class="desc-line">2. 可在「我的会籍」查看会籍状态与分享任务</text>
                <text class="desc-line">3. 申请分享并完成任务，年度结束可退还会费</text>
              </view>
            </view>
            <view class="btn-row">
...
const canNext2 = computed(() => !!selectedRole.value)
