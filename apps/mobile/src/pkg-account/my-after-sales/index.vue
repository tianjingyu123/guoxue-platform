<template>
  <view class="page">
    ...
    <!-- 取消确认弹窗 -->
    <view v-if="cancelId" class="mask" @tap="cancelId = ''">
...
import { afterSaleApi, afterSaleList, afterSaleTabs, afterSaleStatusConfig } from '@/lib/account-data'
...
onLoad(async () => {
  ...
  } catch { list.value = [...afterSaleList] }
})
...
async function doCancel() {
  try { await afterSaleApi.cancelAfterSale(cancelId.value) } catch { }
