<template>
  <view class="page">
    <app-nav-bar title="创建直播" background="rgba(255,255,255,0.95)" color="#2C2C2C" :back-size="40">
      <template #right>
    ...
    <view class="body">
      ...
      <view class="card">
        ...
        <view class="mode-grid">
          <view class="mode-card" :class="{ 'mode-active': liveMode === 'vertical' }" @tap="liveMode = 'vertical'">
            ...
            <view class="mode-icon" :class="{ 'mode-icon-active': liveMode === 'vertical' }">
              <AppIcon name="smartphone" :size="20" :color="liveMode === 'vertical' ? '#fff' : '#666'" />
            </view>
          ...
          <view class="mode-card" :class="{ 'mode-active': liveMode === 'horizontal' }" @tap="liveMode = 'horizontal'">
            <view class="mode-icon" :class="{ 'mode-icon-active': liveMode === 'horizontal' }">
              <AppIcon name="monitor" :size="20" :color="liveMode === 'horizontal' ? '#fff' : '#666'" />
            </view>
        ...
        <view v-if="liveMode === 'horizontal'" class="obs-tip">
          <AppIcon name="settings" :size="16" color="#d97706" />
      ...
      <view class="card">
        ...
        <view class="cover-upload">
          <AppIcon name="camera" :size="40" color="#999999" />
        ...
        <view class="field">
          ...
          <view class="picker-btn" @tap="showDatePicker = true">
            <view class="picker-left">
              <AppIcon name="calendar" :size="20" color="#999999" />
      ...
      <!-- 提示 -->
      <view class="info-tip">
        <AppIcon name="info" :size="16" color="#C9A96E" />
