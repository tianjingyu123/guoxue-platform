...
<template>
  <view class="page">
    <app-nav-bar title="主播列表" background="var(--surface)" color="#2c2c2c" :back-size="40" />

    <view v-if="loading" class="hs-skeleton">
...
/* 骨架 */
.hs-skeleton { padding: 24rpx; display: flex; flex-direction: column; gap: 24rpx; padding-top: 120rpx; }
