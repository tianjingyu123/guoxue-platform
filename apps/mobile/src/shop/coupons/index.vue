...
.sk-coupon { display: flex; background: #fff; border-radius: 16rpx; overflow: hidden; height: 180rpx; }
.sk-left { width: 224rpx; background: #f5f1ea; flex-shrink: 0; }
.sk-right { flex: 1; padding: 24rpx; display: flex; flex-direction: column; gap: 16rpx; justify-content: center; }
