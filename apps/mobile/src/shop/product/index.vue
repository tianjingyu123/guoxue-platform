<template>
  <view class="pd-page">
    ...
    >
      ...
      <view class="sk-price" />
      <view class="sk-title" />
      <view class="sk-title sk-title-short" />
      <view class="sk-spec" />
      <view class="sk-desc" />
    </view>
...
/* 加载骨架屏 */
.sk-page { padding: 0 32rpx; }
.sk-nav { height: 88rpx; }
.sk-gallery { height: 560rpx; border-radius: 24rpx; background: var(--line-soft, #f2efea); margin: 24rpx 0; }
.sk-price { height: 64rpx; width: 50%; border-radius: 12rpx; background: var(--line-soft, #f2efea); margin-bottom: 24rpx; }
.sk-title { height: 36rpx; border-radius: 8rpx; background: var(--line-soft, #f2efea); margin-bottom: 16rpx; }
.sk-title-short { width: 65%; }
.sk-spec { height: 120rpx; border-radius: 24rpx; background: var(--line-soft, #f2efea); margin-bottom: 24rpx; }
.sk-desc { height: 200rpx; border-radius: 16rpx; background: var(--line-soft, #f2efea); }
</style>
