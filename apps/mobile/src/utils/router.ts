...
const ROUTE_MAP: Record<string, string> = {
  ...
  '/paipan/jinqianke': '/pkg-paipan3/jinqianke/index',
  ...
  '/paipan/bazhai': '/pkg-paipan3/bazhai/index',
  '/paipan/bazhai/result': '/pkg-paipan3/bazhai/result',
  '/paipan/bazhai/history': '/pkg-paipan3/bazhai/history/index',
  // V0 排盘第四批（姓名数字+五运六气）
  ...
  '/merchant/after-sales': '/pkg-merchant/after-sales/index',
