...
<template>
  <view class="page">
    <view class="nav">
      ...
      <text class="nav-title">隐私授权管理</text>
      <view class="nav-btn" />
    </view>
    ...
    <!-- 授权底部弹窗 -->
    <view v-if="showAuthSheet && selected" class="mask" @tap="showAuthSheet = false">
    ...
    <!-- 已授权提示弹窗 -->
    <view v-if="showAuthorizedDialog && selected" class="mask center" @tap="showAuthorizedDialog = false">
