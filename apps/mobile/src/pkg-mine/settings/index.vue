...
<template>
  <view class="page">
    ...
    >
      ...
      <view class="group">
        ...
        <view class="card">
          ...
          <view
            class="row list-press"
            @tap="navigateTo('/mine/delete-account')"
          >
            <AppIcon
              name="trash-2"
              :size="18"
              color="#ef4444"
            />
            <text class="row-label danger-label">
              账号注销
            </text>
          </view>
        </view>
    ...
    <view
      v-if="showLogout"
      class="mask end mask-fade-in"
      @tap="showLogout = false"
    >
      <view
        class="dialog sheet-slide-up"
        @tap.stop
      >
        ...
        <view class="dialog-actions">
          ...
          <view
            class="dlg-btn danger btn-press"
            @tap="handleLogout"
          >
    ...
    >
      ...
      >
        ...
        <view class="dialog-actions">
          ...
          <view
            class="dlg-btn primary btn-press"
