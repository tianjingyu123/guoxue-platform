<template>
  <view class="page">
    <view class="v0-header">
      <text class="v0-title">AI智能体</text>
      <text class="v0-route">V0: agents</text>
    </view>
            ...
            <view class="px-4 pt-3 pb-4">
              ...
              <view class="relative">
                <view class="flex items-center bg-white rounded-xl px-3 py-2.5 shadow-lg">
                  ...
                  >
                    <Mic class={cn("w-4 h-4", isListening ? "text-white" : "text-[#666]")} />
                  </view>
                </view>
                {isListening && (
    ...
    <view v-for="(bot, index) in displayBots" :key="index"> (
                  ...
                  <view class="bg-white rounded-2xl p-4 shadow-sm">
                    <view class="flex items-start gap-3">
                      ...
                      <view class="relative flex-shrink-0">
                        <view class={cn("w-14 h-14 rounded-xl bg-gradient-to-br flex items-center justify-center", bot.gradient)}>
                      ...
                      <view class="flex-1 min-w-0">
                        <view class="flex items-center gap-2">
                          <text class="font-bold text-[15px] text-[#2C2C2C] truncate">{{ bot.name }}</text>
            ...
            {hotBots.length > 4 && (
              ...
              >
                ...
                <ChevronDown class={cn("w-4 h-4 transition-transform", showAllBots && "rotate-180")} />
              </view>
            )}
          </view>
