<template>
  <view class="page">
    <view class="v0-header">
      <text class="v0-title">智能体</text>
      <text class="v0-route">V0: agent/history</text>
    </view>
    ...
    <view v-for="(item, index) in groupItems" :key="index"> (
                  <view
                    key={item.id}
            ...
            <view class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-8">
              <Card class="w-full max-w-sm p-5">
                <view class="text-center mb-4">
                  ...
                  <text class="font-semibold text-foreground mb-1">清空全部对话</text>
