...
async function loadData() {
  ...
  error.value = ''
  try {
    const res = await orderApi.getUnifiedOrders()
...
.nav-row { display: flex; align-items: center; height: 88rpx; padding: 0 24rpx; }
.nav-back { width: 56rpx; }
.nav-title { flex: 1; text-align: center; font-size: 32rpx; font-weight: 600; color: #2C2C2C; }
...
.loading-spinner { width: 64rpx; height: 64rpx; border: 6rpx solid #E8E3DB; border-top-color: #C41E3A; border-radius: 50%; animation: spin 0.8s linear infinite; margin-bottom: 24rpx; }
...
.retry-btn { margin-top: 24rpx; padding: 16rpx 48rpx; border-radius: 16rpx; background: #C41E3A; }
