...
interface SearchResult {
  ...
  isJoined: boolean; isPaid: boolean; price: number; description: string; tags: string[]
}
...
.sr-tag-rank { font-size: 24rpx; font-weight: 700; color: var(--brand, #C41E3A); }
...
.sr-count-num { color: var(--brand, #C41E3A); font-weight: 500; }
...
.sr-result-price { font-size: 24rpx; color: var(--brand, #C41E3A); font-weight: 500; }
</style>
