    ...
    <view class="ce-body">
      ...
      >
        <view
          ...
          class="ce-skel-card"
        >
          <view class="ce-skel-top">
            <view class="ce-skel-avatar" /><view class="ce-skel-lines">
              <view class="ce-skel-line w60" /><view class="ce-skel-line w40" /><view class="ce-skel-line w80" />
            </view>
          </view>
          <view class="ce-skel-tags">
            <view class="ce-skel-tag" /><view class="ce-skel-tag" /><view class="ce-skel-tag" />
          </view>
          <view class="ce-skel-actions">
            <view class="ce-skel-btn" /><view class="ce-skel-btn" />
          </view>
        </view>
      </view>
