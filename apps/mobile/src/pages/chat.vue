<template>
  <view class="page v0-page" data-v0-route="chat">
          ...
          <view class="sticky top-0 z-50 bg-background/95 backdrop-blur-lg border-b border-border">
            <view class="flex items-center justify-between px-4 h-14">
              ...
              <view class="flex items-center gap-2">
                <text class="h1" class="font-semibold text-lg text-foreground">消息</text>
                {{ totalUnread > 0 && (
          ...
          <view class="divide-y divide-border">
            {filteredConversations.length > 0 ? (
              ...
              <view class="flex flex-col items-center justify-center py-20 px-4">
                ...
                <text class="h3" class="text-base font-medium text-foreground mb-1">
            ...
            {filteredConversations.length > 0 && (
              <view class="p-4 pb-24">
                <view class="flex items-center justify-between mb-3">
                  <text class="h3" class="font-medium text-sm text-foreground">猜你喜欢</text>
                ...
                <view class="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                  <view v-for="(item) in recommendations" :key="index">
                    <Link
                      key={item.id}
