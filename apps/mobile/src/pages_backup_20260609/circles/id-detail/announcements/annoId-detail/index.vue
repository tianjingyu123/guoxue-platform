<template>
  <view class="page" data-v0-route="circles/[id]/announcements/[annoId]">
    
        <view class="placeholder">
          <view class="ph-icon">🏮</view>
          <text class="ph-title">公告</text>
          <text class="ph-sub">复杂度: 10/8</text>
          <text class="ph-route">路由: circles/[id]/announcements/[annoId]</text>
