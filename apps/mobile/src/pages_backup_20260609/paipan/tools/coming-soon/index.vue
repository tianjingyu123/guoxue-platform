<template>
  <view class="page" data-v0-route="paipan/tools/coming-soon">
    
        <view class="placeholder">
          <view class="ph-icon">🏮</view>
          <text class="ph-title">排盘工具</text>
          <text class="ph-sub">复杂度: 5/8</text>
          <text class="ph-route">路由: paipan/tools/coming-soon</text>
