<template>
  <view class="page" data-v0-route="paipan/bazi/history/celebrities">
    
        <view class="placeholder">
          <view class="ph-icon">🏮</view>
          <text class="ph-title">历史</text>
          <text class="ph-sub">复杂度: 4/8</text>
          <text class="ph-route">路由: paipan/bazi/history/celebrities</text>
