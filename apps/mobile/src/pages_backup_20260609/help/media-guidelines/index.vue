<template>
  <view class="page" data-v0-route="help/media-guidelines">
    
        <view class="placeholder">
          <view class="ph-icon">🏮</view>
          <text class="ph-title">帮助中心</text>
          <text class="ph-sub">复杂度: 6/8</text>
          <text class="ph-route">路由: help/media-guidelines</text>
