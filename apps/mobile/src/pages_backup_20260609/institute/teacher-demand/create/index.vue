<template>
  <view class="page" data-v0-route="institute/teacher-demand/create">
    
        <view class="placeholder">
          <view class="ph-icon">🏮</view>
          <text class="ph-title">研究院</text>
          <text class="ph-sub">复杂度: 0/8</text>
          <text class="ph-route">路由: institute/teacher-demand/create</text>
