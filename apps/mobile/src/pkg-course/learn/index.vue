...
<template>
  <view class="page">
    <!-- 顶部导航 -->
    <app-nav-bar :title="course.title" background="#fff" color="#2C2C2C" />

    <!-- 三态模式：骨架屏 / 错误 / 内容 -->
    <view v-if="loading" class="pl-skeleton sk-learn">
      <view class="sk-ring-card">
        <view class="sk-ring" />
        <view class="sk-ring-meta"><view class="sk-ring-title" /><view class="sk-ring-line" /><view class="sk-ring-line" /></view>
      </view>
      <view class="sk-tab-bar"><view class="sk-tab" /><view class="sk-tab" /><view class="sk-tab" /></view>
      <view class="sk-lesson-list">
        <view class="sk-lesson-row"><view class="sk-lesson-ico" /><view class="sk-lesson-line" /></view>
        <view class="sk-lesson-row"><view class="sk-lesson-ico" /><view class="sk-lesson-line" /></view>
        <view class="sk-lesson-row"><view class="sk-lesson-ico" /><view class="sk-lesson-line" /></view>
        <view class="sk-lesson-row"><view class="sk-lesson-ico" /><view class="sk-lesson-line" /></view>
      </view>
...
.sk-learn { padding: 32rpx; }
.sk-ring-card { display: flex; align-items: center; gap: 32rpx; background: #fff; padding: 32rpx; border-radius: 0; margin: -32rpx; margin-bottom: 24rpx; }
.sk-ring { width: 160rpx; height: 160rpx; border-radius: 50%; background: #F2EFEA; flex-shrink: 0; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-ring-meta { flex: 1; }
.sk-ring-title { width: 60%; height: 32rpx; background: #F2EFEA; border-radius: 8rpx; margin-bottom: 16rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-ring-line { width: 80%; height: 24rpx; background: #F2EFEA; border-radius: 6rpx; margin-bottom: 12rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-ring-line:last-child { width: 50%; margin-bottom: 0; }
.sk-tab-bar { display: flex; gap: 24rpx; margin-bottom: 32rpx; }
.sk-tab { flex: 1; height: 56rpx; background: #F2EFEA; border-radius: 8rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-lesson-list { display: flex; flex-direction: column; gap: 16rpx; }
.sk-lesson-row { display: flex; align-items: center; gap: 24rpx; padding: 24rpx; background: #fff; border-radius: 16rpx; box-shadow: 0 2rpx 8rpx rgba(0,0,0,0.04); }
.sk-lesson-ico { width: 48rpx; height: 48rpx; border-radius: 50%; background: #F2EFEA; flex-shrink: 0; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-lesson-line { flex: 1; height: 28rpx; background: #F2EFEA; border-radius: 6rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
</style>
