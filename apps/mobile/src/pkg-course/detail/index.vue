...
.sk-cover-block { height: 448rpx; background: #F2EFEA; border-radius: 0; margin: -32rpx; margin-bottom: 24rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-inst-card { height: 160rpx; background: #fff; border-radius: 24rpx; padding: 32rpx; display: flex; align-items: center; margin-bottom: 32rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-inst-left { width: 96rpx; height: 96rpx; border-radius: 50%; background: #F2EFEA; }
.sk-tabs { display: flex; gap: 48rpx; margin-bottom: 32rpx; }
.sk-tab { width: 80rpx; height: 40rpx; background: #F2EFEA; border-radius: 8rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-cover-info { position: absolute; bottom: 32rpx; left: 32rpx; right: 32rpx; }
.sk-ci-tag { width: 80rpx; height: 32rpx; background: rgba(255,255,255,0.3); border-radius: 8rpx; margin-bottom: 16rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-ci-title { width: 60%; height: 48rpx; background: rgba(255,255,255,0.3); border-radius: 8rpx; margin-bottom: 16rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
.sk-ci-meta { display: flex; gap: 32rpx; }
.sk-ci-meta-item { width: 120rpx; height: 28rpx; background: rgba(255,255,255,0.3); border-radius: 6rpx; animation: sk-pulse 1.5s ease-in-out infinite; }
</style>
