  ...
  <view class="page">
    ...
    <view v-if="loading" class="body">
      ...
      <view class="pl-skeleton">
        <view class="sk-card">
          <view class="sk-title" />
          <view class="sk-cal"><view v-for="i in 4" :key="i" class="sk-cal-row"><view v-for="j in 7" :key="j" class="sk-cal-cell" /></view></view>
          <view class="sk-legend" />
        </view>
        <view class="sk-card">
          <view class="sk-title" />
          <view class="sk-goal"><view v-for="i in 3" :key="i" class="sk-goal-item" /></view>
          <view class="sk-week"><view v-for="i in 7" :key="i" class="sk-week-cell" /></view>
        </view>
        <view class="sk-card">
          <view class="sk-title" />
          <view class="sk-task-item" v-for="i in 2" :key="i" />
        </view>
        <view class="sk-card">
          <view class="sk-title" />
          <view class="sk-course-item" v-for="i in 2" :key="i" />
        </view>
      </view>
    </view>
