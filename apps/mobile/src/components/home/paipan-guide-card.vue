...
/** 排盘引导大卡（原型 PaipanGuideCard）：宣纸纹理 + 八卦底纹 + 太极旋转图标 + CTA */
...
.pp-card {
  ...
  box-shadow: 0 4rpx 32rpx rgba(201, 169, 110, 0.15), 0 2rpx 8rpx rgba(0, 0, 0, 0.04);
}
.paper-texture {
...
.title {
  font-family: var(--font-serif); font-weight: 700; font-size: 34rpx;
