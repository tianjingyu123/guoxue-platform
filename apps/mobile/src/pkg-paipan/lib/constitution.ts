...
export const CONSTITUTIONS: Constitution[] = [
  ...
  },
  {
    ...
    // 🔴 2026-09-21 剔除「黄芪」：宜食清单只列食材，黄芪不在《既是食品又是中药材的物质目录》
    //    （卫法监发〔2002〕51 号）内，属中药材，需辨证与剂量，不该出现在「宜食」里。
    //    余下五味（山药/小米/大枣/鸡肉/南瓜）均为药食同源之品，补气已足。
    favorFoods: ["山药", "小米", "大枣", "鸡肉", "南瓜"],
  ...
  },
  {
    ...
    // 🔴 2026-09-21 剔除「桃仁」：同样不在药食同源目录，且**含苦杏仁苷有小毒**、
    //    生活中易与「核桃仁」混淆误食。余下五味均为药食同源的活血化瘀之品。
    favorFoods: ["山楂", "黑木耳", "红糖", "玫瑰花茶", "醋"],
