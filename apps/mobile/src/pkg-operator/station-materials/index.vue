<template>
  <view class="mat-page">
    ...
    <view v-else class="mat-body">
      <!-- 海报区 -->
      <view v-if="(activeTab === 'all' || activeTab === 'poster') && posters.length" class="mat-section">
      ...
      <!-- 文案区 -->
      <view v-if="(activeTab === 'all' || activeTab === 'copywriting') && copywritings.length" class="mat-section">
        <view class="mat-section-title">
      ...
      <!-- 二维码区 -->
      <view v-if="(activeTab === 'all' || activeTab === 'qrcode') && qrcodes.length" class="mat-section">
        <view class="mat-section-title">
