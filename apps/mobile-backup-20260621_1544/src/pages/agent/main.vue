...
const pageData = ref<{ welcome: string; quickPrompts: string[]; reply: string } | null>(null)

async function loadMain() {
  loading.value = true
  error.value = null
  try {
    const res = await agentApi.main()
    pageData.value = res
  } catch (e: any) {
...
<template>
  <view class="page">
    ...
    <SimpleChat
      ...
      :quick-prompts="pageData!.quickPrompts"
