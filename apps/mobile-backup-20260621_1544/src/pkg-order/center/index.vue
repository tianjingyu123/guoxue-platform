    ...
    <view class="content">
      ...
      >
        ...
        <view class="card-head">
          ...
          <text
            class="card-status"
            :style="{ color: (statusConfig as any)[order.status].color }"
          >
            {{ (statusConfig as any)[order.status].label }}
          </text>
        </view>
...
import { orderApi, orderCategories, unifiedStatusConfig, categoryColorMap, type OrderCategory, type UnifiedOrderStatus } from '@/lib/order-data'
