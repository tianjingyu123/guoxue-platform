...
const order = ref<OrderDetail>({
  id: '', orderNo: '', status: 'pending_pay', totalAmount: 0, payAmount: 0,
  createdAt: '', products: [],
  canCancel: false, canConfirm: false, canReview: false, hasAfterSale: false,
  address: { id: '', name: '', phone: '', province: '', city: '', district: '', address: '', isDefault: false },
})
