...
function handleJoin() {
  if (!isJoined.value) {
    ...
    Promise.resolve(circleDetailApi.leave(circleId.value)).catch(() => { isJoined.value = true })
  }
}
function confirmJoin() {
  showBenefits.value = false
  isJoined.value = true
  Promise.resolve(circleDetailApi.join(circleId.value)).catch(() => { isJoined.value = false })
}
