...
.sk-wrap { padding: 24rpx; display: flex; flex-direction: column; gap: 24rpx; }
.sk-card { background: #fff; border-radius: 24rpx; padding: 28rpx; display: flex; flex-direction: column; gap: 16rpx; }
.sk-row { height: 200rpx; background: #f0ece4; border-radius: 16rpx; }
.sk-line { height: 24rpx; background: #f0ece4; border-radius: 8rpx; }
.sk-short { width: 60%; }
.sk-line.w4 { width: 40%; }
.sk-group { display: flex; gap: 16rpx; align-items: center; }
.sk-avatar { width: 64rpx; height: 64rpx; border-radius: 50%; background: #f0ece4; flex-shrink: 0; }
