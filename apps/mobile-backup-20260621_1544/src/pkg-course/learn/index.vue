...
const chapters = ref<LearnChapter[]>([])
const notes = ref<any[]>([])
...
function submitQuestion() {
  if (!askContent.value.trim() || submitting.value) return
...
async function loadData() {
  ...
  error.value = ''
  try {
    const res = await courseApi.learnData(courseId.value)
...
<template>
  <view class="page">
    ...
    <view
      v-if="loading"
      class="pl-skeleton sk-learn"
    >
      <view class="sk-ring-card">
        <view class="sk-ring" />
        <view class="sk-ring-meta">
          <view class="sk-ring-title" /><view class="sk-ring-line" /><view class="sk-ring-line" />
        </view>
      </view>
      <view class="sk-tab-bar">
        <view class="sk-tab" /><view class="sk-tab" /><view class="sk-tab" />
      </view>
      <view class="sk-lesson-list">
        <view class="sk-lesson-row">
          <view class="sk-lesson-ico" /><view class="sk-lesson-line" />
        </view>
        <view class="sk-lesson-row">
          <view class="sk-lesson-ico" /><view class="sk-lesson-line" />
        </view>
