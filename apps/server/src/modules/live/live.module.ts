...
@Module({
  ...
  providers: [LiveService, LivePresenceService, LiveMixingService, TrtcCallbackGuard, LiveQualityService, LiveStreamService, LiveDashboardService, LiveDataCollectorService, LiveReportService],
