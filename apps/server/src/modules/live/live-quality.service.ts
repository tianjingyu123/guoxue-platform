 ...
 *
 * 定价（董事长拍板 2026-07-10·1元=10国学币·按小时计价）：
 *   高清 720p：13元/时（130币/时）→ 10时包 130元(1300币)、30时包 390元(3900币)
 *   超清 1080p：28元/时（280币/时）→ 10时包 280元(2800币)、30时包 840元(8400币)
 *   （套餐数据见 prisma/manual/2026-07-10-billing-decisions.sql·按 quality+minutes 幂等重定价）
 *
