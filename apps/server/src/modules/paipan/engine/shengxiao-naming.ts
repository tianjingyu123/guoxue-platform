...
const ROOT_RADICALS: Record<string, string[]> = {
  ...
  马: ["马", "馬"],
  羊: ["羊"],
  // 🔴 2026-09-21：生肖组原先只有 ROOT_EXTRA 没有部首项，于是「午马」不含马部首字（骐骥驹驿），
  //    而部首组「马」又不含「午/南/竹/杵」。hitRoot 是「部首 ∪ 扩展字」的并集，
  //    给生肖组补上部首项即可两向都不丢 —— 地支关系一律改用生肖组（见下方各生肖规则）。
  午马: ["马", "馬"],
  未羊: ["羊"],
  鸟: ["鸟", "鳥", "隹", "羽"],
  虫: ["虫"],
...
export const SHENGXIAO_RULES: Record<string, ZodiacRule> = {
  鼠: {
    ...
    bad: [
      ...
      { group: "午马", reason: "子午相冲" },
      { group: "未羊", reason: "子未相害" },
    ],
  ...
  牛: {
    ...
    bad: [
      { group: "午马", reason: "丑午相害" },
      { group: "未羊", reason: "丑未相冲" },
  ...
  兔: {
    fav: [
      ...
      // 🔴 2026-09-21 补：卯戌六合原先只在「狗」那一边登记（狗的 fav 明写「卯戌六合」），
      //    兔这边漏了，导致同一个六合关系方向不同结果不同 ——
      //    属狗者用含卯兔字根的字得 +1，属兔者用含戌狗字根的字（成城诚盛国献然…）却得 0。
      { group: "戌狗", reason: "卯戌六合" },
    ...
    note: "宜艹木得食、口宀得穴、亥未三合、戌狗六合、彩衣之根；忌酉辰、金、肉心与日。",
  },
  龙: {
    fav: [
