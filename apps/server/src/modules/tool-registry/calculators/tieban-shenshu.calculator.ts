...
const TIAOWEN_LIB: TiaoWen[] = [
  ...
  { number:7005, category:"健康", text:"中年发福，宜坚持锻炼，节制饮食可保健康。", jiXiong:"平" },
  { number:7006, category:"健康", text:"先天元气足，百病不侵，一生少有疾患。", jiXiong:"吉" },
  ...
  { number:8004, category:"迁徙", text:"东南方利，向东南发展事业腾达。", jiXiong:"吉" },
  { number:8005, category:"迁徙", text:"不宜北行，北方水土不服，宜就近发展。", jiXiong:"平" },
  { number:8006, category:"迁徙", text:"海外有缘，出国发展可获大成。", jiXiong:"吉" },
  ...
  { number:9004, category:"交友", text:"益友良多，得道多助，朋友是你最大的财富。", jiXiong:"吉" },
  { number:9005, category:"交友", text:"知交二三即可，不必泛泛，精诚之交最为贵。", jiXiong:"吉" },
  { number:10001, category:"总论", text:"命格中上，福寿双全，一生平顺，安享天年。", jiXiong:"大吉" },
  { number:10002, category:"总论", text:"命格中等，有起有落，靠自身努力可获成就。", jiXiong:"吉" },
  { number:10003, category:"总论", text:"早年辛苦，中年发迹，晚年安康，先苦后甜。", jiXiong:"吉" },
  { number:10004, category:"总论", text:"一生平稳，无大起大落，知足常乐者得福。", jiXiong:"吉" },
  { number:10005, category:"总论", text:"命运多舛，但意志坚定者可破格而出。", jiXiong:"平" },
];
