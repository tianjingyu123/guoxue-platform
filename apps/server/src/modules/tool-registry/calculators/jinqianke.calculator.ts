...
const ALL_GUA_FULL: GuaFull[] = [
  ...
  {name:"天火同人",symbol:"䷌",key:"777787",shangGua:"乾",xiaGua:"离",guaCi:"同人于野，亨。利涉大川，利君子贞。",jiXiong:"吉",shiYe:"合作顺利，团队和谐。",caiYun:"合伙生财，利益均沾。",ganQing:"志趣相投，感情融洽。",yaoCi:["同人于门，无咎。","同人于宗，吝。","伏戎于莽，升其高陵，三岁不兴。","乘其墉，弗克攻，吉。","同人先号咷而后笑。","同人于郊，无悔。"]},
  ...
  {name:"天雷无妄",symbol:"䷘",key:"777788",shangGua:"乾",xiaGua:"震",guaCi:"元亨利贞。其匪正有眚，不利有攸往。",jiXiong:"半吉",shiYe:"脚踏实地，不投机取巧。",caiYun:"财运真实可靠。",ganQing:"真心相待，不虚情假意。",yaoCi:["无妄往，吉。","不耕获不菑畬，则利有攸往。","无妄之灾，或系之牛。","可贞无咎。","无妄之疾，勿药有喜。","无妄行，有眚无攸利。"]},
  ...
  {name:"坎为水",symbol:"䷜",key:"878878",shangGua:"坎",xiaGua:"坎",guaCi:"习坎，有孚，维心亨，行有尚。",jiXiong:"凶",shiYe:"面临困难，需保持信心。",caiYun:"财运险中有机，谨慎把握。",ganQing:"感情经历考验，真心不改。",yaoCi:["习坎，入于坎窞凶。","坎有险，求小得。","来之坎坎，险且枕，入于坎窞勿用。","樽酒簋贰，用缶纳约自牖，终无咎。","坎不盈，祗既平无咎。","系用徽纆，寘于丛棘，三岁不得凶。"]},
  ...
  {name:"泽水困",symbol:"䷮",key:"887878",shangGua:"兑",xiaGua:"坎",guaCi:"亨，贞大人吉，无咎。有言不信。",jiXiong:"凶",shiYe:"事业困顿，需耐心坚守。",caiYun:"财运困窘，资金紧张。",ganQing:"感情陷入困境。",yaoCi:["臀困于株木，入于幽谷三岁不觌。","困于酒食，朱绂方来。","困于石，据于蒺藜。入于其宫不见其妻凶。","来徐徐，困于金车，吝有终。","劓刖，困于赤绂。乃徐有说。","困于葛藟，于臲卼。曰动悔有悔。"]},
  ...
  {name:"火山旅",symbol:"䷷",key:"787788",shangGua:"离",xiaGua:"艮",guaCi:"小亨，旅贞吉。",jiXiong:"半吉",shiYe:"事业在外，奔波劳碌。",caiYun:"财运在外，旅途获利。",ganQing:"感情如旅途，聚散有时。",yaoCi:["旅琐琐，斯其所取灾。","旅即次，怀其资得童仆贞。","旅焚其次，丧其童仆贞厉。","旅于处，得其资斧我心不快。","射雉一矢亡，终以誉命。","鸟焚其巢，旅人先笑后号咷。"]},
