...
const NA_YIN_WU_XING: Record<string, string> = {
  ...
  "涧下水":"水","井泉水":"水","长流水":"水","天河水":"水","大溪水":"水","大海水":"水",
...
const NA_YIN_DB: Record<string, Omit<NayinItem, "pairs">> = {
  ...
  "井泉水": {
    name: "井泉水", shortName: "井泉",
    wuXing: "水",
    imagery: "地下泉眼之水，源头活水，生生不息",
    jiXiong: "吉",
    detail: "甲申乙酉井泉水者，申为金旺，酉为金盛。金生水而源源不绝，如泉眼涌流。命带井泉水者，智慧深藏、灵感不断，适合科研、发明、教育、文化等需要灵感的行业。",
