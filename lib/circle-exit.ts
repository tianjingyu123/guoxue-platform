...
export const mockExitRequests: ExitApplication[] = [
  {
    ...
    circleId: "1",
    circleName: "八字命理研习社",
    user: { id: "u1", name: "林清远", avatar: "/placeholder.svg?height=48&width=48" },
    joinDate: "2024-05-15",
  ...
  },
  {
    ...
    circleId: "1",
    circleName: "八字命理研习社",
    user: { id: "u2", name: "苏晚晴", avatar: "/placeholder.svg?height=48&width=48" },
    joinDate: "2024-03-01",
  ...
  },
  {
    ...
    circleId: "1",
    circleName: "八字命理研习社",
    user: { id: "u3", name: "陈墨白", avatar: "/placeholder.svg?height=48&width=48" },
    joinDate: "2024-01-10",
  ...
  },
  {
    ...
    circleId: "1",
    circleName: "八字命理研习社",
    user: { id: "u4", name: "王浩然", avatar: "/placeholder.svg?height=48&width=48" },
    joinDate: "2024-06-01",
...
export const mockMyExitApps: ExitApplication[] = [
  {
    ...
    circleId: "2",
    circleName: "紫微斗数高阶班",
    user: { id: "me", name: "我", avatar: "/placeholder.svg?height=48&width=48" },
    joinDate: "2024-04-20",
